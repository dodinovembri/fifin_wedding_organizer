        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <a href="<?php echo base_url('admin/feature/create') ?>"><button type="button" class="btn btn-primary" style="margin-bottom: 20px;">Add New</button></a>
                        ...
                        <tbody>
                            ...
                            foreach ($features as $key => $value) {
                                ...
                                <tr>
                                    ...
                                    <td style="width: 20%;"><img src="<?php echo base_url('uploads/feature/'); echo $value->image; ?>" width="50%" alt=""></td>
                                    <td><?php echo substr($value->description, 0, 50) ?></td>
                                    <td><?php echo check_status($value->status); ?></td>
                                    <td>
                                        <a href="<?php
                                                    echo base_url('admin/feature/show/');
                                                    echo $value->id;
                                                    ?>"><span class="icon-eye"></span>&nbsp;</a>
                                        <a href="<?php
                                                    echo base_url('admin/feature/edit/');
                                                    echo $value->id;
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?php
                                                            echo base_url('admin/feature/destroy/');
                                                            echo $value->id;
