            ...
            <div class="card-body">
                ...
                <div id="example-form">
                    ...
                    <section>
                        <h6 class="h-0 m-0">&nbsp;</h6>
                        <div class="row gutters">
                            <form action="<?php echo base_url('admin/wedding_gallery/update/');
                                            echo $wedding_gallery->id; ?>" method="POST" enctype="multipart/form-data">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="field-wrapper m-0">
                                        <textarea name="description" id="" cols="30" rows="3"><?php echo $wedding_gallery->description ?></textarea>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="field-wrapper">
                                        <select name="status" class="form-select" id="formSelect">
                                            <option value="<?php echo $wedding_gallery->status ?>"><?php echo check_status($wedding_gallery->status) ?></option>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    ...
                                    <div class="field-wrapper">
                                        ...
                                        <a href="<?php echo base_url('admin/wedding_galleries/'); echo $this->session->userdata('wedding_invitation_id') ?>"><button type="button" class="btn btn-danger">Cancel</button></a>
                                    </div>
