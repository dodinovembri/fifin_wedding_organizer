                        ...
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="field-wrapper">
                                    <input type="text" name="code" value="<?php echo $feature->code ?>" disabled>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="field-wrapper">
                                    <input type="text" name="name" value="<?php echo $feature->name ?>" disabled>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <!-- Field wrapper start -->
                                <div class="field-wrapper">
                                    <input type="text" value="<?php echo check_status($feature->status) ?>">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="field-wrapper">
                                    <a href="<?php echo base_url('admin/feature') ?>"><button type="submit" class="btn btn-primary">Kembali ke List</button></a>
                                </div>
