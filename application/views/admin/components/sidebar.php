							...
							<div class="sidebarMenuScroll">
								<div class="sidebar-menu">
									<ul>
										...
										<li>
											<a href="<?php echo base_url('admin/order') ?>" class="<?php if ($this->uri->segment(2) == "order"){ echo "current-page"; } ?>">Order</a>
										</li>
									</ul>
								</div>
							</div>
