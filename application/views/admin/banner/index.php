        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <a href="<?php echo base_url('admin/banner/create') ?>"><button type="button" class="btn btn-primary" style="margin-bottom: 20px;">Add New</button></a>
                    <table id="basicExample" class="table custom-table">
                        ...
                        <tbody>
                            ...
                            foreach ($banners as $key => $value) {
                                ...
                                <tr>
                                    <td><?php echo $no; ?></td>
                                    <td style="width: 20%;"><img src="<?php echo base_url('uploads/banner/'); echo $value->image; ?>" width="50%" alt=""></td>
                                    <td><?php echo substr($value->description, 0, 50) ?></td>
                                    <td><?php echo check_status($value->status); ?></td>
                                    <td>
                                        <a href="<?php echo base_url('admin/banner/show/');
                                                    echo $value->id ?>"><span class="icon-eye"></span>&nbsp;</a>
                                        <a href="<?php echo base_url('admin/banner/edit/');
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?php echo base_url('admin/banner/destroy/'); echo $value->id; ?>"><button type="button" class="btn btn-primary">Delete</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
