        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <a href="<?php echo base_url('admin/contact/create') ?>"><button type="button" class="btn btn-primary" style="margin-bottom: 20px;">Add New</button></a>
                        ...
                        <tbody>
                            ...
                            foreach ($contacts as $key => $value) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $value->opening_hours; ?></td>
                                    <td><?php echo check_status($value->status); ?></td>
                                    <td>
                                        <a href="<?php
                                                    echo base_url('admin/contact/show/');
                                                    echo $value->id;
                                                    ?>"><span class="icon-eye"></span>&nbsp;</a>
                                        <a href="<?php
                                                    echo base_url('admin/contact/edit/');
                                                    echo $value->id;
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?php
                                                            echo base_url('admin/contact/destroy/');
                                                            echo $value->id;
