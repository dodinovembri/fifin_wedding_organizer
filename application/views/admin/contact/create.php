            ...
            <div class="card-body">
                ...
                <div id="example-form">
                    ...
                    <section>
                        <h6 class="h-0 m-0">&nbsp;</h6>
                        <div class="row gutters">
                            <form action="<?php echo base_url('admin/contact/store') ?>" method="POST" enctype="multipart/form-data">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="field-wrapper m-0">
                                        <textarea name="address" id="" cols="30" rows="7" required></textarea>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="field-wrapper m-0">
                                        <textarea name="about" id="" cols="30" rows="7" required></textarea>
