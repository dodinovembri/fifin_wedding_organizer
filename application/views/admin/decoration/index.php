        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Decoration List</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">Decoration List</div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <?php $this->load->view('admin/components/flash') ?>
                    <a href="<?php echo base_url('admin/decoration/create') ?>"><button type="button" class="btn btn-primary" style="margin-bottom: 20px;">Add New</button></a>
                        ...
                        <tbody>
                            ...
                            foreach ($decorations as $key => $value) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php
                                                    echo base_url('admin/decoration/show/');
                                                    echo $value->id;
                                                    ?>"><span class="icon-eye"></span>&nbsp;</a>
                                        <a href="<?php
                                                    echo base_url('admin/decoration/edit/');
                                                    echo $value->id;
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?php
                                                            echo base_url('admin/decoration/destroy/');
                                                            echo $value->id;
