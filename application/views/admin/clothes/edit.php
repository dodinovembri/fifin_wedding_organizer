            ...
            <div class="card-body">
                ...
                <div id="example-form">
                    ...
                    <section>
                        ...
                        <div class="row gutters">
                            <form action="<?php
                                            echo base_url('admin/clothes/update/');
                                            echo $clothes->id;
                                            ?>" method="POST" enctype="multipart/form-data">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">

                                    <div class="field-wrapper">
                                        <input type="text" name="code" value="<?php echo $clothes->code ?>" required>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="field-wrapper">
                                        <input type="text" name="name" value="<?php echo $clothes->name ?>" required>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="field-wrapper">
                                        <select name="status" class="form-select" id="formSelect">
                                            <option value="<?php echo $clothes->status ?>"><?php echo check_status($clothes->status) ?></option>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                    ...
                                    <div class="field-wrapper">
                                        ...
                                        <a href="<?php echo base_url('admin/clothes') ?>"><button type="button" class="btn btn-danger">Cancel</button></a>
                                    </div>
